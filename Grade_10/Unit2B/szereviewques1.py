...
def main():
    ...
    #only the area of rhombus needs height and base
        ...
        print("The area of the rhombus is",szeformulas.arhombus(height,base))
    ...
    #all the others only need one side of the shape
        ...
        if user == "1":
            print("The area of the square is",szeformulas.asquare(side_length))
        #user picked perimeter of square
        elif user == "2":
            print("The perimeter of the square is",szeformulas.perimeter(side_length))
        #user picked perimeter of rhombus (option 4)
        else:
            print("The perimeter of the rhombus is",szeformulas.perimeter(side_length))
